...
export const IMAGE_MODELS = [
    ...
    {
        label: 'Stable Diffusion XL（HF 免费额度）',
...
export const VIDEO_MODELS = [
    ...
    //     key: 'kling-v2-1',
    //     provider: ['chatfire'], // 仅OpenAI 兼容渠道
...
export const CHAT_MODELS = [
    { label: 'OpenRouter Free Router', key: 'openrouter/free', provider: ['openrouter'] },
    { label: 'DeepSeek Chat V3 Free', key: 'deepseek/deepseek-chat-v3-0324:free', provider: ['openrouter'] },
    { label: 'Qwen3 235B Free', key: 'qwen/qwen3-235b-a22b:free', provider: ['openrouter'] },
    { label: 'Gemini Flash（免费额度）', key: 'gemini-3.5-flash', provider: ['gemini'] },
    { label: 'GPT OSS 20B（HF 免费额度）', key: 'openai/gpt-oss-20b', provider: ['huggingface'] },
