      ...
      <div class="p-3 space-y-3">
        ...
        <div
          ...
          <span class="px-2 py-0.5 rounded-full"
            :class="connectedPrompts.length > 0 ? 'bg-slate-200 text-slate-700 dark:bg-slate-700/40 dark:text-slate-200' : 'bg-gray-100 text-gray-500 dark:bg-gray-800'">
...
watch(() => modelStore.selectedImageModel, (newModel) => {
  if (!props.data?.model && newModel) {
